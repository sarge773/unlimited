...
// used by the rest of the icons, and it is filled with `currentColor` so it
// stays legible on the light and dark tile. No mark is redrawn, recomposed or
// restyled. Each official mark already ships as a single-colour artwork, so the
// whole set is monochrome and inherits the page's foreground colour; that also
// keeps the row at one visual weight, which brand colours at 20px did not.
//
...
//   cline     Cline        simple-icons `cline` (cline.bot/assets/branding)              CC0-1.0
//   continue  Continue     continuedev/continue `docs/logo/dark.svg`                     Apache-2.0
//   aider     Aider        Aider-AI/aider `aider/website/assets/icons/safari-pinned-tab.svg`  Apache-2.0
//   opencode  OpenCode     simple-icons `opencode` (opencode `packages/identity/mark.svg`)   CC0-1.0
//   goose     Goose        block/goose `documentation/static/img/goose.svg`              Apache-2.0
//   qwen      Qwen Code    simple-icons `qwen` (qwen.ai)                                 CC0-1.0
//   roo       Roo Code     RooCodeInc/Roo-Code `src/assets/icons/icon.svg`               Apache-2.0
//   kilo      Kilo Code    Kilo-Org/kilocode `packages/kilo-console/public/kilo-logo.svg`  Apache-2.0
//   cursor    Cursor       simple-icons `cursor` (cursor.com/brand)                      CC0-1.0
//
...
// symbol. `generic` is not a brand: it is our own terminal glyph, on the same
// lucide grid and weight as the icons used elsewhere in the app.
...
const marks: Record<string, ReactNode> = {
  ...
  opencode: (
    <path
      d="M19.35 20.82H4.68V3.22h14.67zM15.68 6.74H8.35v10.56h7.33z"
    />
  ),
  // Goose
  goose: (
  ...
  // Any other OpenAI-compatible client: our own terminal glyph, not a brand mark.
  generic: (
